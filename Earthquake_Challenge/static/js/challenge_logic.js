...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
 console.log(data);
  ...
  //   opacity: 1,
  //   fillOpacity: 1,
  //   fillColor: getColor_mag(feature.properties.mag),
  //   color: "#000000",
  //   radius: getRadius_mag(feature.properties.mag),
  //   stroke: true,
  //   weight: 0.5
  // })
  ...
  function styleInfo_mag(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
      fillColor: getColor_mag(feature.properties.mag),
  ...
  function getColor_mag(magnitude) {
    if (magnitude < 5) {
      return "#ea2c2c";
    }
    if (magnitude > 5) {
  ...
  function getRadius_mag(magnitude) {
    if (magnitude === 0) {
      return 1;
    }
    return magnitude * 4;
